...
// Q2. Given n rofes of different lengths, connect them into a single rofe with minimum cost. Assume that the 
// cost to connect two rofes is the same as the sum of their lengths.
